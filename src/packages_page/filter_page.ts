...
export class FilterPage extends from(Adw.NavigationPage, {
	remotes: Property.gobject(Gio.ListModel).as<Gio.ListModel<Remote>>(),
	runtimes: Property.gobject(Gio.ListModel).as<Gio.ListModel<Package>>(),
	installations: Property.gobject(Gio.ListModel).as<Gio.ListModel<Installation>>(),
